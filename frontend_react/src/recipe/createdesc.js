    ...
    return (
        ...
        <Form.Row style={{marginTop:"1em"}}>
            <Form.Group as={Col}>
                ...
                <Form.Control onChange={e => props.setName(e.target.value)} required />
            </Form.Group>
        </Form.Row>
        <Form.Row style={{marginTop:"1em"}}>
            <Form.Group as={Col}>
                <Form.Label>Type</Form.Label>
                <Form.Control as="select" onChange={e => props.setType(e.target.value)} required defaultValue="">
            ...
            <Form.Group as={Col}>
                ...
                <Form.Control onChange={e => props.setTime(e.target.value)} type="number" required />
            </Form.Group>
            <Form.Group as={Col}>
