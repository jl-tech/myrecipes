...
def do_search(name, type, serving_size, time_to_cook, ingredients, step_key_words):
    ...
    query = """
        select distinct R.recipe_id,  R.name, R.creation_time, R.edit_time, R.time_to_cook, R.type, R.serving_size, RP.photo_path, R.description, U.first_name, U.last_name, U.profile_pic_path, U.user_id
        from Recipes R
