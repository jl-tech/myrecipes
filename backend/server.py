...
def view_image(filename):
    return redirect(
        url_for('static', filename='./server_resources/images/' + filename),
        code=301)
...
if __name__ == "__main__":
    ...
    # print(auth.add_new_user('jonathan.liu2000@gmail.com', 'Test', '2',
    # 'goodpassword'))
    # print(auth.email_already_exists('jonathan.liu2000@gmail.com'))
    ...
    # .eyJwYXNzd29yZCI6IiQyYiQxMiRRMThSR1JhL0wwM3RXVHdWWkpNbS9PbEpvcC9WUmwuZkhOMGtqZk53MkVlR0ZjT0V3Z2VweSJ9._yDmsNIp1YmVztrmnuRWUQZ80W7-RCmcCAAxP1XXaPM', 'newpwd'))
    # End testing code
