...
function HomePage(props) {
    ...
    return (
        <>
            ...
            <div style={{overflow: 'hidden', margin: 0, background: "url(http://127.0.0.1:5000/img/home_cover.jpg)", backgroundSize: "cover",  height: "calc(100vh - 4em)", width: "auto", backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}}>
