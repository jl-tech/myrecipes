        ...
        <>
            <Row>
                <Modal.Dialog
                    ...
                    onClick={() =>
                        history.push("/profile/" + props.contributorUID)
                    }
                ...
                >
                    ...
                    <Modal.Body>
                        ...
                        <Row style={{ textAlign: "center" }}>
                            ...
                            >
                                <tbody>
                                    <b>{props.contributorRecipes} </b> Recipes{" "}
                                    <br />
                                    <b> {props.contributorSubscribers} </b>{" "}
                                    Subscribers
                                </tbody>
                            </table>
                        </Row>
            ...
            {props.editedAt != null ? (
                <>
                    ...
                    <Row>
                        <Col style={{ textAlign: "center" }}>
                            <ReactTimeAgo
                                date={new Date(props.editedAt)}
                                locale="en-US"
                            />
                            <br />
                            <small className={"text-muted"}>
                                {new Date(props.editedAt).toLocaleDateString(
                                    "en-GB"
                                ) +
                                    " " +
                                    new Date(props.editedAt).toLocaleTimeString(
                                        "en-GB"
                                    )}
                            </small>
                        </Col>
