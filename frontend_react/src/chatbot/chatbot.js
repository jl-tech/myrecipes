...
function ChatBot(props) {
    ...
    const [showTip, setShowTip] = useState(localStorage.getItem('show_tip') !== null
        ? localStorage.getItem('show_tip') !== "0" : true)
    ...
    function handleClickIcon() {
        if (localStorage.getItem('chatlog_expires') !== null &&
        ...
        setAttr({
            ...
            messages: localStorage.getItem('chatlog') !== null ?
